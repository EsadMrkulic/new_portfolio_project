...
class Application(models.Model):
    ...
    position = models.ForeignKey(Position, on_delete=models.CASCADE, db_column='position_id', null=False)
    applicant = models.ForeignKey(Applicant, on_delete=models.CASCADE, db_column='applicant_id', null=False)
    reviewed_by_manager = models.ForeignKey(Manager, on_delete=models.CASCADE, db_column='reviewed_by_manager_id', default=1, null=False)
